...
OBJS=threading_queue.o function_queue.o pt_error.o indexed_array_queue.o
...
threading_queue.o: threading_queue.c threading_queue.h function_queue.o pt_error.o
	$(CC) $(CFLAGS) -c -o $@ $<
